...
To add, reorder, or temporarily exclude mascot frame sequences, regenerate `claude_art.c`, and keep keymap indices in sync, see **[docs/claude-view-animations.md](docs/claude-view-animations.md)**.
